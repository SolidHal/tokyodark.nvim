...
M.highlights = {
    ...
    FoldColumn = { fg = p.fg, bg = p.bg0 } + transparent_bg,
    ...
    NonText = { fg = p.bg_whitespace },
    Whitespace = { fg = p.bg_whitespace },
    SpecialKey = { fg = p.bg4 },
    ...
    Identifier = { fg = p.creme } + styles.identifiers,
    Constant = { fg = p.creme } + styles.variables,
    PreProc = { fg = p.red },
    PreCondit = { fg = p.red },
    Include = { fg = p.lavender },
    Keyword = { fg = p.lavender } + styles.keywords,
    Define = { fg = p.lavender },
    ...
    ["@variable"] = { fg = p.orange, default = false } + styles.variables,
    ...
    markdownH3 = { fg = p.purple, bold = true },
